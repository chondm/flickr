namespace :scrap do
  ...
  def intial
    ...
    flickr.get_access_token("72157642575190174-ac6a1899afc89cfe", "224ab2a3326e0a4d", "359-927-900")
  ...
  task :members_from_a_group => :environment do
    intial
    groups = ["35468135891@N01", "94761711@N00", "48111895@N00"]
    # Save group
    groups.each do |id|
